...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void CreateNewAccount() {
        ...
        if(TextUtils.isEmpty(email)){
            Toast.makeText(this,"Please give your email here ",Toast.LENGTH_SHORT).show();
        }
        else if(TextUtils.isEmpty(password)){
            Toast.makeText(this,"Please give your password here ",Toast.LENGTH_SHORT).show();
        }

        else if(TextUtils.isEmpty(confirmPassword)){
            Toast.makeText(this,"Please confirm your password here ",Toast.LENGTH_SHORT).show();
        }
